  ...
  return (
    <div id='home'>
      <div className='h-screen w-full bg-[#1e2125] text-[#e9dfce] font-[Serif] text-4xl flex justify-center items-center flex-col leading-none px-4 md:w-full overflow-hidden '>
        ...
        <div
          className=' text-5xl lg:text-[184px] italic font-extrabold  leading-[1.6]  md:leading-[0.8] cursor-none'
          ref={delightfulRef}
          onMouseEnter={textEnter}
          onMouseLeave={textLeave}
        >
        ...
        <div
          className='absolute bottom-5 left-0  md:left-5  text-base md:text-xl font-mono indent-4 cursor-none'
          ref={workRef}
        ...
        <div
          ...
          onMouseLeave={textLeave}
        >
          <h1><a href="https://drive.google.com/file/d/1qNvL3Fn5n02WIkZQbzq5-MzFc1LJivT9/view" target='_blank'  className='cursor-pointer'>View Resume →</a></h1>
        </div>
      </div>
    </div>
  )
