...
const About = () => {
    ...
    return (
        <div className='min-h-screen w-full bg-[#1e2125] text-[#e9dfce] font-[Yesteryear] flex flex-col md:flex-row justify-center items-center px-4 md:px-8 lg:px-20 xl:px-80 py-10 md:py-0 gap-6 md:gap-10'>
            <img
                ref={imageRef}
